...
public class AES {
    ...
    public static void main(String[] args) {
        ...
        BigInteger plaintext = new BigInteger("CAFEBABE", 16);
        BigInteger encryptionKey = new BigInteger("cafebabe", 16);
        BigInteger temp = encrypt(plaintext, encryptionKey);
        System.err.println(temp.toString(16));
        BigInteger ciphertext = new BigInteger(temp.toString(16), 16);
        BigInteger decryptionKey = new BigInteger("cafebabe", 16);
        String decryption=decrypt(ciphertext, decryptionKey).toString(16);
